...
I'm experimenting with 6 week cycles in my team. Having read about the entire process (summarized below), I am pleased to note that we already follow a lot of the best practices. Working on low-fi mockups, writing tech briefs, discussing with experts, frequent demos and pushing for MVP playtest are important. There are process differences e.g., daily standups, sprint planning, JIRA tickets. Other differences reflect the reality of working in a large organization - oncall work, unplanned work, re-orgs, shifting priorities, hiring/firing, performance management, remote work environment, etc. Many of these are contextual so I will scope them out.

Important takeaways for me personally were (1) the reversal of the question "how long will this take" to "what can we ship in 6 weeks", (2) managers should allow DRIs to be flexible with scope - ultimately we'll sign-off but DRIs should be comfortable enough to have these discussions and (3) creating the tech brief based on low-fi mockups is best. We should continue to use JIRA since we're not on Basecamp (and hence cannot use "hill maps"). However, we can give DRIs more space to drive planning and stop worrying about "story points". We should track bugs/tech debt as they arise. Demos are extremely valuable. Finaly, standups provide a forum to bond as a team and flag risks to projects - we don't need a tool for everything.
