...
Feel like consulting work - these codebases are long lived.
Trust - it depends on the skill of the coders.
Remote work.
...
* We use analogy of the "hill". ![_config.yml]({{ site.baseurl }}/images/hill.png)
...
* When to stop?
  ...
  * **If we aim for an ideal perfect design, we'll never get there. But we don't want to lower standards.**
  * **Instead of comparing against the ideal, compared it to the baseline - the current reality for customers.**
