...
Many firms integrate 30/60/90 days plans into their processes but they're typically directed towards individual contributors. Managers, however, have a more complex role. In previous posts, I referenced how Will Larson describes various teams states and states that managers have to apply different fixes depending on the state of the team. Daniel Goleman expounds on 6 different leadership styles for different teams. It's clear that crafting a 30/60/90 day plan is very contextual to the needs of the business, and the problem is it takes a lot of time and effort to assess this. So how does one transition themselves towards successs?

Watkins proposes a few fundamental principles to enable successful transitions for new employees. Some of these mirror Goleman's observations, for example, to not assume that what worked in a past role will work again. Watkins also explains that different business context requires different leadership approaches and to avoid implementing massive changes right out of the gate. Watkins also discusses SWOT analysis and provides tips to create a compelling vision.

On the other hand, Watkins has a practical approach to corporate culture, exhorting managers to build influence vertically but also horizontally with peers. Watkins states that it is critical to map out spheres of influence and deciphering "hidden politics" within an organization. Watkins also proposes securing early wins, but makes it clear that wins should ladder up to a long term goal rather than low hanging fruit. Most illuminating to me were conversations to align your manager, to be proactive, taking ownership of building the relationship and negotiating success. Very early in my career, I recognized times I fell into these traps, for example, not making an effort to schedule in-person time or long periods without contact. People close have also fallen into traps, expecting their managers to adapt to their styles instead of the other way round.

I would highly recommend budding managers to read and reflect on their journeys while reading this book. I have written down some notes from my reading that I personally found thought provoking and hope that you enjoy them too.
...
* **Consider these six criteria to evaulate a person:**
