...
I have managed a manager for about 1 year and managed ICs for the last 5 years. As a manager of managers, it was much harder to find time to code. Mentally, I couldn't justify it and felt that my output as a manager was low. I could use my time to plan or developing others. Over time, my distance from the codebase grew and it was increasingly difficult to make decisions with conviction. I had to instead obtain answers from trusted engineers and build relationships with stakeholders to align on decisions.

I transitioned from a tech lead to a manager around 5 years ago. During the initial days, I was still producing high quality PRs every week. However, with org shifts, I had to work with new codebases and languages where I didn't have familiarity. This is a more common scenario for a seasoned manager. My approach was to use breakpoints to debug code and understand the architecture. With LLMs, this is now much easier and I often find answers myself and verify them in code. **These days, I strongly believe that managers should use LLMs to understand the codebase first before disrupting ICs.** The cost of doing this is much lower and the information that you glean is often invaluable. You notice a lot of nesting, anti-patterns, massive functions, TODOs and this **helps you ask better questions to your senior engineers**. The answers to these questions are often surprising and indicate bottlenecks to engineering velocity.

Will creates 4 PRs per week as a CTO of 50 engineers. The actual bottleneck in an agentic world is not creating PRs but reviewing PRs, so I hope his output isn't overly disruptive. Will did emphasize that these PRs are not in the critical path. In general, **a typical codebase has a lot of easy tech debt that managers can contribute towards with relatively low effort and high impact** e.g., deleting feature flags, adding metrics, fixing p2 vulnerabilities, polish items, scaling and sizing, refining CLAUDE.md, creating agentic skills, refining agentic commands, etc. 
...
The answer to "should managers code at work" depends on the team state. A team that is falling behind would need managers to implement necessary fixes while a more stable team might afford the manager more time to investigate code. I think **the better question is "how much should a manager code at work"**, implying that managers should always keep this question in the back of their mind and consider it seriously when they have space because it unlocks a lot of insights.